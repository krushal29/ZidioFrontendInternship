  ...
  const fetchGraphCounts = async () => {
    try {
      ...
      if (res.data?.message?.length > 0) {
        setGraphCounts(res.data.message[0]); 
      }
    } catch (err) {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-10 rounded-xl">
          <div className="bg-blue-300 rounded-lg shadow p-6">
            <h2 className="text-xl font-bold text-gray-700 mb-2 poppins-medium">Total Users</h2>
            <p className="text-3xl font-bold text-blue-600 winky-sans">
              {Array.isArray(users) ? users.length : 0}
            </p>
          </div>
          <div className="bg-green-300 rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-700 mb-2 poppins-medium">Total Files</h2>
            <p className="text-3xl font-bold text-green-600 winky-sans">{stats.totalFiles}</p>
          </div>
          <div className="bg-purple-300 rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-700 mb-2 poppins-medium">Active Sessions</h2>
            <p className="text-3xl font-bold text-purple-600 winky-sans">{stats.activeSessions}</p>
          </div>
        </div>
        ...
        {graphCounts && (
          <div className="bg-white rounded-lg shadow p-6 mb-10">
            <h2 className="text-2xl font-bold text-gray-800 mb-4 montserrat-mont1">Graph Usage Statistics</h2>
            <Bar
            height={100}
              data={{
                labels: [
                ...
                datasets: [
                  {
                    label: "# of Times Used",
                    data: [
                      graphCounts.BarChart,
                      graphCounts.BarChart3D,
                      graphCounts.LineChart,
                      graphCounts.PieChart,
                      graphCounts.DonutChart,
                      graphCounts.ScatterPlot,
                      graphCounts.ScatterPlot3D,
                      graphCounts.Histogram,
                    ],
